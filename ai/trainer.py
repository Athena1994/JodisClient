...
from ai.q_arbiter import QArbiter, QFunction, DeepQFunction, DQNWrapper
from ai.replay_buffer import ReplayBuffer, Experience
...
def calculate_target_q(target_dqn: DQNWrapper,
                       rewards: Tensor,
                       next_states: Tensor,
...
class TestTrainer(unittest.TestCase):
    ...
    def test_perform_training_session(self):
        ...
        #
        trainer_loss = trainer.perform_training(batch_size, 1)
    ...
    def test_dqn(self):
        ...
        arbiter = QArbiter(DeepQFunction(dqn), 0.3)
